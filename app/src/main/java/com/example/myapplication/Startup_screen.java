...
public class Startup_screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            createButton = findViewById(R.id.CreateAccButton);
            startLoginButton = findViewById(R.id.StartLoginButton);

            createButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Startup_screen.this, Register.class);
            ...
            startLoginButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Startup_screen.this, loginPage.class);
                    startActivity(intent);
                }
            });
            return insets;
